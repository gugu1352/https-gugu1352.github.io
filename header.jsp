...
<nav id="header-box">
    <div class="container">
        ...
        <a href="{url home}" class="logo"> 校园二手交易平台 </a>
            ...
            <ul>
                ...
                <c:choose>
                    <c:when test="${sessionScope.username != null && sessionScope.username !=  '' }">
                        <li>
                            <a href="main.jsp"><i class="icon icon-user"></i>${sessionScope.username},${sessionScope.cx}</a>
                        </li>
                        <li>
                            <a href="user.do?ac=logout"><i class="fa fa-sign-out"></i>退出</a>
                        </li> </c:when
                    ><c:otherwise>
                    <li>
                        <a href="yonghu.do?ac=addweb">用户注册 </a>
                    </li>
                        <li>
        ...
        <div class="navigation navigation-main">
            ...
            <div class="floating-menu">
                ...
                <ul id="navbar-str">
                            ...
                            <div class="navbar-box">
                                <div class="box-full">
                                    <div class="box clearfix">
                                        <ul>
                                            <ssm:sql var="mapwupinfenlei1" type="select">SELECT id,fenleimingcheng FROM wupinfenlei</ssm:sql>
                                            <c:forEach items="${mapwupinfenlei1}" var="m">
                                                <li><a href="wupinxinxi.do?ac=index&fenlei=${m.id}">${m.fenleimingcheng}</a></li>
                                            </c:forEach>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="gonggaoxinxi.do?ac=index">公告信息 </a>
                    </li>
        ...
        <div class="search-wrapper">
            <form action="wupinxinxi.do?ac=index" method="get">
                <input type="hidden" name="ac" value="index" />
                <div class="search-input-group">
                    <i class="fa fa-search search-icon"></i>
                    <input type="text" name="wupinmingcheng" value="${param.wupinmingcheng}" class="form-control" 
                           placeholder="搜索物品名称、关键词..." id="searchInput" autocomplete="off" />
            ...
            <div class="hot-search-tags">
                ...
                <a href="wupinxinxi.do?ac=index&wupinmingcheng=手机" class="hot-tag">手机</a>
                <a href="wupinxinxi.do?ac=index&wupinmingcheng=电脑" class="hot-tag">电脑</a>
                <a href="wupinxinxi.do?ac=index&wupinmingcheng=自行车" class="hot-tag">自行车</a>
                <a href="wupinxinxi.do?ac=index&wupinmingcheng=教材" class="hot-tag">教材</a>
            </div>
        </div>
        ...
        <div class="login-wrapper">
            ...
            <form action="user.do?ac=login&a=a" method="post">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <span class="input-group-addon"><img src="captch.do" style="width: 60px; height: 20px; max-width: none; max-height: none" onclick="this.src='captch.do?rand='+new Date().getTime()" /></span>
                    </div>
                </div>
